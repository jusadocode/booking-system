...
export default function FinalStep({ selectedRoom, bookingDates, breakfastRequests, expandedHotel }) {
    ...
    const totalPrice = selectedRoom.price * numberOfNights + totalBreakfast + cleaningFee


    return (
        <Box sx={{ mt: 2, mb: 1 }}>
            <Typography variant='h6'>
                Incoming booking information
            </Typography>
            <Typography variant='body1'>
                Make sure you check the details carefully before proceeding with the booking
            </Typography>
            <Box sx={{ mt: 2 }}>
                ...
                <Typography variant='body2'>
                    <strong>Check-in date:</strong> {bookingDates[0].format('MMMM D, YYYY')}
                </Typography>
                <Typography variant='body2'>
                    <strong>Check-out date:</strong> {bookingDates[1].format('MMMM D, YYYY')}
                </Typography>
                <Typography variant='body2'>
                ...
                <Box sx={{ textAlign: 'right', mt: 2, }}>
                    ...
                    {breakfastRequests > 0 && (
                        <Typography variant='body2'>
                            Breakfast for: {breakfastRequests} {breakfastRequests === 1 ? 'person' : 'people'} (15€ per person per day)
                        </Typography>
                    )}
                    <Typography variant='body2'>
